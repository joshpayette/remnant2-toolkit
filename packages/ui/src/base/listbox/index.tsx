  ...
  return (
    <div className="ui-p-2">
      <Headless.Listbox {...props} multiple={multiple}>
        ...
        <Headless.Transition
          as={Fragment}
          leave="ui-transition-opacity ui-duration-100 ui-ease-in ui-pointer-events-none ui-overflow-x-scroll"
      ...
      {({ selectedOption }) => {
        ...
        return (
          ...
          >
            ...
            <span className={cn(className, sharedClasses, 'ui-col-start-2')}>
              {children}
            </span>
          </div>
        );
