...
- Added CTA for upcoming Return to Ward 13 community event!
...
- Removed "fuck" and "fuckin" from the bad word filters.

## 2025-09-24

## Fixed

- Several contributors were missing from the CONTRIBUTORS.md file. This has been corrected.

## 2025-09-19

### Fixed

- mpeg is the greatest and resolved the issue with the Genesis code not working.

## 2025-09-16

### Added

- Added note to the Genesis Code display that it is currently not calculating correctly.

## 2025-08-14

### Fixed

- Build description popout icon no longer shows in screenshots.

## 2025-08-11

### Fixed

- Video thumbnails above the build no longer show the black bars around the thumbnail. (thanks, maru!)
...
- Improved the UI for the quality build feed on the home page, particularly while items are loading.
