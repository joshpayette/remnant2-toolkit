    ...
    >
      <HeadlessTextarea
        className={clsx([
          ...
          // Basic layout
          'relative box-border block h-full w-full appearance-none rounded-lg px-[calc(theme(spacing[3.5])-1px)] py-[calc(theme(spacing[2.5])-1px)] sm:px-[calc(theme(spacing.3)-1px)] sm:py-[calc(theme(spacing[1.5])-1px)]',
          ...
          // Invalid state
          'data-[invalid]:border-accent3-600 data-[invalid]:data-[hover]:border-accent3-600',
