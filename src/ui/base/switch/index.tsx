  ...
  return (
    <HeadlessSwitch
      className={clsx(
        ...
        // Disabled
        'data-[disabled]:bg-surface-solid/15 data-[disabled]:data-[checked]:bg-surface-solid/15 data-[disabled]:opacity-50 data-[disabled]:data-[checked]:ring-surface-solid/15',
