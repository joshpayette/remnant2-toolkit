...
export const modItems: ModItem[] = [
  ...
  },
  {
    ...
    id: 'k7z7r2',
    dlc: 'base',
    description: `Banishes enemies or allies into another dimension for 4s. When Banish ends, enemies take 1.25x the damage from the Repulsor's primary fire for 8s. Powerful enemies won't be banished, but will take increased damage from any Repulsor while debuffed.`,
  ...
  },
  {
    ...
    id: 'hpfdzp',
    dlc: 'base',
    description: `Fires an explosive round that deals up to 175 FIRE damage within 9m and applies BURNING, dealing 250 FIRE damage over 5s.`,
    externalTokens: [`Amplitude`, `Explosive Damage`],
  ...
  },
  {
    ...
    Activating the mod calls down a Guardian Sword on enemies struck by an Empowered Energy Disc. Swords deal 450 damage and 3x stagger within 3m.`,
    externalTokens: [`Amplitude`, `Explosive Damage`],
  ...
  },
  {
    ...
    id: '1mtqkk',
    dlc: 'base',
    description: `Shoots a helix of missiles, dealing 120 damage Explosive Damage. On contact, divides into 6 smaller rockets which seek additional targets, dealing 30 damage Explosive Damage on contact.`,
  ...
  },
  {
    ...
    dlc: 'dlc1',
    id: 'aobtw7',
    description: `Rapidly fires volatile needles that explode after 1.5s dealing 90 explosive damage Explosive Damage.`,
  ...
  },
  {
    ...
    id: 'vgin4w',
    dlc: 'base',
    description: `Fires a rotten arrow that deals 75 damage and detonates for another 100 damage within 1.5m.`,
    externalTokens: [`Amplitude`, `Explosive Damage`],
  ...
  },
  {
    ...
    id: 'ozNPv9',
    tags: [],
    description: `Launch a sphere of loam. Impact creates a 5m swirling storm of sand which seeks to center itself on an enemy and deals 75 Elemental Damage per second. When Sandstorm's focused target dies, it will seek a new enemy within 10m. Lasts 15s.`,
    externalTokens: [`Amplitude`],
  ...
  },
  {
    ...
    The song continues for 15s, afflicting targets within 15m with SLOW, and a 10% decrease to damage.`,
    externalTokens: [`Amplitude`, `Explosive Damage`],
  ...
  },
  {
    ...
    id: '4wd3gm',
    dlc: 'base',
    description: `Launch an alien egg that bursts on impact, releasing 5 Space Crabs. Crabs follow the caster, leaping towards enemies within 4m, and exploding, dealing 60 damage Explosive Damage each.`,
  ...
  },
  {
    ...
    id: 'g6glpj',
    dlc: 'base',
    description: `Fires a projectile that cracks the ground and spawns shockwaves that deal 75 damage within 9m for 6s. Shockwaves inflict 3x impact.`,
    externalTokens: [`Amplitude`, `Explosive Damage`],
