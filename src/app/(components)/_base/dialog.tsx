    ...
    <HeadlessTransition appear as={Fragment} show={open} {...props}>
      <HeadlessDialog onClose={onClose}>
        <HeadlessTransitionChild
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 z-[5] flex w-screen justify-center overflow-y-auto bg-zinc-950/50 px-2 py-2 focus:outline-0 sm:px-6 sm:py-8 lg:px-8 lg:py-16" />
        </HeadlessTransitionChild>

        <HeadlessTransitionChild
          className="fixed inset-0 z-[5] w-screen overflow-y-auto pt-24 sm:p-4"
          enter="ease-out duration-100"
