...
const styles = {
  ...
  solid: [
    ...
    'after:shadow-[shadow:inset_0_1px_theme(colors.surface.solid/15%)]',
  ...
  outline: [
    // Base
    'border-zinc-950/10 text-surface-solid data-[active]:bg-zinc-950/[2.5%] data-[hover]:bg-zinc-950/[2.5%]',

    // Dark mode
    'dark:border-white/15 dark:[--btn-bg:transparent] dark:data-[active]:bg-white/5 dark:data-[hover]:bg-white/5',
  ...
  plain: [
    // Base
    'border-transparent text-surface-solid data-[active]:bg-zinc-950/5 data-[hover]:bg-zinc-950/5',
  ...
  colors: {
    ...
    light: [
      'text-surface-solid [--btn-bg:white] [--btn-border:theme(colors.zinc.950/10%)] [--btn-hover-overlay:theme(colors.zinc.950/2.5%)] data-[active]:[--btn-border:theme(colors.zinc.950/15%)] data-[hover]:[--btn-border:theme(colors.zinc.950/15%)]',
      'dark:[--btn-hover-overlay:theme(colors.surface.solid/5%)] dark:[--btn-bg:theme(colors.zinc.800)]',
      '[--btn-icon:theme(colors.zinc.500)] data-[active]:[--btn-icon:theme(colors.zinc.700)] data-[hover]:[--btn-icon:theme(colors.zinc.700)] dark:[--btn-icon:theme(colors.zinc.500)] dark:data-[active]:[--btn-icon:theme(colors.zinc.400)] dark:data-[hover]:[--btn-icon:theme(colors.zinc.400)]',
    ],
    'dark/white': [
      'text-surface-solid [--btn-bg:theme(colors.zinc.900)] [--btn-border:theme(colors.zinc.950/90%)] [--btn-hover-overlay:theme(colors.surface.solid/10%)]',
    ...
    dark: [
      'text-surface-solid [--btn-bg:theme(colors.black)] [--btn-border:theme(colors.zinc.950/90%)] [--btn-hover-overlay:theme(colors.surface.solid/10%)]',
      'dark:[--btn-hover-overlay:theme(colors.surface.solid/5%)] dark:[--btn-bg:theme(colors.zinc.800)]',
      '[--btn-icon:theme(colors.zinc.400)] data-[active]:[--btn-icon:theme(colors.zinc.300)] data-[hover]:[--btn-icon:theme(colors.zinc.300)]',
    ],
    white: [
    ...
    zinc: [
      'text-white [--btn-hover-overlay:theme(colors.surface.solid/10%)] [--btn-bg:theme(colors.zinc.600)] [--btn-border:theme(colors.zinc.700/90%)]',
      'dark:[--btn-hover-overlay:theme(colors.surface.solid/5%)]',
      '[--btn-icon:theme(colors.zinc.400)] data-[active]:[--btn-icon:theme(colors.zinc.300)] data-[hover]:[--btn-icon:theme(colors.zinc.300)]',
    ],
    indigo: [
