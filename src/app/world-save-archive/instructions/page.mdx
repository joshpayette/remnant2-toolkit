...
At the moment we only accept submissions from a group of trusted contributors to ensure the quality and safety of all files. If you possess a large collection on save files you can join our discord and submit them for a review.

### Do I have to own all DLCs to use these files?

We do not seperate files by DLC requiremnt. If the file contains DLC content you don't own it won't work.
