...
import { MobileLayoutToggle } from '@/app/(items)/item-quiz/_components/mobile-layout-toggle';
import { QuizItemButton } from '@/app/(items)/item-quiz/_components/quiz-item-button';
import { TopScoresLeaderBoard } from '@/app/(items)/item-quiz/_components/top-scores-leader-board';
...
export const GameOverStage = React.memo(
  ({
    ...
    <div className="flex w-full flex-col items-center justify-center">
      <h2 className="text-accent3-500 mb-2 text-2xl font-bold">
