...
function CardImage({ item }: { item: ItemCardProps['item'] }) {
  return (
    <div className={`relative flex h-[64px] w-full grow items-center justify-center overflow-hidden bg-[url('https://${process.env.NEXT_PUBLIC_IMAGE_URL}/card-body-bg.jpg')]`}>
      {item && (
        <Image
  ...
  return (
    <div className="relative w-full min-w-full">
      <div className="flex w-full min-w-full flex-col items-center justify-center">
        <div className={`h-[48px] w-full bg-[url('https://${process.env.NEXT_PUBLIC_IMAGE_URL}/card-title-bg.jpg')] p-2 text-center`}>
