      ...
      <div className="flex w-full flex-grow flex-col justify-start">
        <div className="flex w-full flex-row items-center justify-start">
          <div className="flex w-full flex-col items-start justify-start sm:max-w-[275px]">
            <div className="relative grid w-full grid-cols-2 gap-2 border border-transparent border-b-primary text-left text-sm text-gray-300">
            ...
            <div className="grid w-full grid-cols-2 gap-x-2">
              ...
              <div className="grid w-full grid-cols-2 gap-2 border border-transparent border-b-primary text-left text-sm text-gray-300">
                <Image
