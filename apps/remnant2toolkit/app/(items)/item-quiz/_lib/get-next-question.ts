import { GAME_ITEM_CATEGORIES } from '@/app/(items)/item-quiz/_constants/game-item-categories';
import { TOTAL_CHOICES } from '@/app/(items)/item-quiz/_constants/total-choices';
import { getItemsInCategory } from '@/app/(items)/item-quiz/_lib/get-items-in-category';
